...
ColliderInfoSphere::ColliderInfoSphere(bool is_trigger, uint32_t category, uint32_t mask)
    : ColliderInfo(Type::Sphere, is_trigger, category, mask)
    , world_center_(VGet(0, 0, 0)) 
{
}

ColliderInfoSphere::ColliderInfoSphere(const VECTOR& local_center, float radius,
